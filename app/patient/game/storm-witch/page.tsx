...
export default function StormWitchPage() {
  ...
  return (
    <div className="fixed inset-0 bg-black">
      <iframe
        src="/witch_runner/index.html?patientId=edwin-001"
        className="w-full h-full border-0"
        title="Storm Witch - DXTR Grip Therapy Game"
        allow="autoplay; bluetooth; serial"
      />
